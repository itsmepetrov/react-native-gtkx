// Panel 7 shows the refusal warnings ON SCREEN rather than only on stderr,
// because a demo whose "this is refused" case looks identical to its "this
// works" case is not showing anything. So `console.warn` is wrapped here —
// ordinary JavaScript, no platform API — and the panel reads the buffer.
//
 ...
 * a panel that has already shown its warning stops re-rendering.
 */
