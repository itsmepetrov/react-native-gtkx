// The counters behind the Reanimated section's render readout, and the honest
// machinery for showing them.
//
...
/** The derived-value demo's crossings, kept out of state for the same reason. */
let crossings = 0
 ...
 * readout renders; nothing being measured is on this clock, and the section
 * says so on screen.
 */
 ...
 * turned off for the gallery in eslint.config.ts, with the same reasoning the
