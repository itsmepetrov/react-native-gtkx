...
//      docs/gtkx-rc2-notes.md, docs/research/navigation-extensibility.md
...
//      the gtkx-rc2-notes live-workaround rows) — a full-text search corpus
...
const RC2_NOTES_MD = join(ROOT, "docs/gtkx-rc2-notes.md")
...
const rc2NotesText = readFileSync(RC2_NOTES_MD, "utf8")
...
const workaroundChunks = workaroundsTable.rows.map(
  ([name, whatRc2Does, ourWorkaround, removalCondition]) => ({
    doc: "docs/gtkx-rc2-notes.md",
    heading: `RC2-WORKAROUND(${stripBacktickSpan(name)})`,
    text: `${whatRc2Does} — our workaround: ${ourWorkaround} — removed when: ${removalCondition}`,
  }),
)
...
const docChunks = [
  ...
  ...parseSections(rc2NotesText, "docs/gtkx-rc2-notes.md"),
